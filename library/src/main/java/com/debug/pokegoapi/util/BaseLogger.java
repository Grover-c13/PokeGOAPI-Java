...
import com.debug.pokegoapi.util.Log.Level;

import static com.debug.pokegoapi.util.Log.Level.DEBUG;
import static com.debug.pokegoapi.util.Log.Level.INFO;
import static com.debug.pokegoapi.util.Log.Level.VERBOSE;
import static com.debug.pokegoapi.util.Log.Level.WARN;
import static com.debug.pokegoapi.util.Log.Level.ERROR;
import static com.debug.pokegoapi.util.Log.Level.ASSERT;

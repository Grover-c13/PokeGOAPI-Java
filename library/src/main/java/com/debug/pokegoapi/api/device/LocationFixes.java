package com.debug.pokegoapi.api.device;
...
public class LocationFixes extends ArrayList<SignatureOuterClass.Signature.LocationFix> {
	 ...
	 */
	public static LocationFixes getDefault(InfoHolder api, RequestEnvelopeOuterClass.RequestEnvelope.Builder builder,
		...
		locationFixes.setTimestampCreate(System.currentTimeMillis());
			...
			locationFixBuilder.setProvider("fused")
					.setTimestampSnapshot(
							contains(negativeSnapshotProviders, i)
									...
									: System.currentTimeMillis() - api.getStartTime()

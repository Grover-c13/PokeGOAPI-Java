...
public class Evolutions {
	...
	static {
		...
		registerEvolution(PICHU, PIKACHU, RAICHU);
		...
		registerEvolution(CLEFFA, CLEFAIRY, CLEFABLE);
		registerEvolution(VULPIX, NINETALES);
		registerEvolution(IGGLYBUFF, JIGGLYPUFF, WIGGLYTUFF);
		...
		registerEvolution(ELEKID, ELECTABUZZ);
		registerEvolution(MAGBY, MAGMAR);
		registerEvolution(SMOOCHUM, JYNX);
	}

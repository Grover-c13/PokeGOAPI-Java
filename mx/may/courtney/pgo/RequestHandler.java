...
import mx.may.courtney.pgo.Pgo.RequestEnvelop.Builder;
import mx.may.courtney.pgo.Pgo.ResponseEnvelop;
...
public class RequestHandler 
{
	...
	public void sendRequests()
	{
		...
		try 
		{
			...
			ResponseEnvelop responseEnvelop = Pgo.ResponseEnvelop.parseFrom(content);
	...
	{
		builder =  Pgo.RequestEnvelop.newBuilder();
